    ...
    var It = /px/,
      ...
      bt = function (t, e) {
        return e.reduce(function (t, e) {
          return (
            null == t[e.type] &&
              (t[e.type] = xt[e.type] || e.defaultValue || 0),
            t
          );
        }, t || {});
      };
  ...
  function (t, e, n) {
    ...
    r.define(
      ...
      (t.exports = function (t, e) {
        ...
        function y() {
          (n = l.find(p)).length &&
            (n.each(T), c || (m(), r.resize.on(I), r.redraw.on(s.redraw)));
        }
        function m() {
        ...
        function D(e, n) {
          ...
          if (e.index !== e.previous) {
            if (
              ...
              return (
                (b = "opacity " + w + "ms " + m),
                f(h).set({ visibility: "" }).add(b).start({ opacity: 0 }),
                void f(v)
...
Webflow.require("ix2").init({
  events: {
    ...
    "e-90": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "63ef293b8ea58d23ecd1490c|484edc58-010f-25aa-9c75-e6a71c8e55cf",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-95": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "63ef293b8ea58d23ecd1490c|0a1a1992-aa84-0fdc-5388-937fc907c7d6",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-96": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "63ef293b8ea58d23ecd1490c|0a1a1992-aa84-0fdc-5388-937fc907c7d9",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-99": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "63ef293b8ea58d23ecd1490c|0a1a1992-aa84-0fdc-5388-937fc907c7e0",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-101": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "63ef293b8ea58d23ecd1490c|0a1a1992-aa84-0fdc-5388-937fc907c7e7",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-102": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "63ef293b8ea58d23ecd1490c|0a1a1992-aa84-0fdc-5388-937fc907c7ee",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-105": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "63ef293b8ea58d23ecd1490c|0a1a1992-aa84-0fdc-5388-937fc907c7f5",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-106": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "63ef293b8ea58d23ecd1490c|0a1a1992-aa84-0fdc-5388-937fc907c7fc",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-108": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        selector: ".udesly-paragraph-large-2",
        originalId:
          "632d9a646d06405e98849663|135a3157-c61d-fa45-c153-1a0a42270610",
        appliesTo: "CLASS",
      },
    ...
    "e-111": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        selector: ".testimonial-slider-large.scrollanimate",
        originalId:
          "63ef293b8ea58d23ecd1490c|1885488e-9a33-a250-cfec-cf6e4003e498",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-113": {
      ...
      target: {
        appliesTo: "ELEMENT",
        styleBlockIds: [],
        id: "63ef293b8ea58d23ecd1490c|1de75fb4-82b3-5b61-1feb-30b991ddd46d",
      },
      targets: [],
      config: {
        loop: false,
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["a00540a9-db5b-8abb-5bbc-c2ba5c723ec3"],
                },
                value: 0,
                unit: "",
              },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".cf-tab-paragraph-contain",
                  selectorGuids: ["529d9e86-a132-d280-9817-508cf378b4da"],
                },
                value: "none",
              },
            },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".cf-tab-heading",
                  selectorGuids: ["529d9e86-a132-d280-9817-508cf378b4db"],
                },
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".cf-tab-icon",
                  selectorGuids: ["529d9e86-a132-d280-9817-508cf378b4dc"],
                },
                filters: [
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: true,
                  id: "63ef293b8ea58d23ecd1490c|5cc820b5-dd65-e386-e373-db5c19e0b543",
                },
                value: 0,
                unit: "",
              },
